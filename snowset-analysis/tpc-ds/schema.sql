-- Based on: https://github.com/fivetran/benchmark/blob/master/300-PopulateSnowflake.sh
-- Modified attribute names to match newer TPC-DS standard and therefore queries from https://github.com/gregrahn/tpcds-kit

drop schema tpcds100;
create schema tpcds100;
